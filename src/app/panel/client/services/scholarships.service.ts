...
export class ScholarshipsService {
  ...
  public recommendedScholarships = signal<number[]>([]);
  ...
  constructor() {
    ...
    const recommendedScholarships = sessionStorage.getItem('recommendedScholarships');
    if (recommendedScholarships) {
      this.recommendedScholarships.set(JSON.parse(recommendedScholarships));
    }
  }
